                ...
                <tbody className="text-sm">
                  {filteredRecords.map((record, i) => (
                    <motion.tr
                      ...
                      transition={{ delay: 0.15 + i * 0.06, duration: 0.3, ease: [0.25, 0.46, 0.45, 0.94] }}
                    ...
                    >
                      ...
                      <td className="py-3 px-4 text-center">
                        <motion.span
                          ...
                          transition={{ delay: 0.25 + i * 0.06, duration: 0.3, type: 'spring', stiffness: 300, damping: 20 }}
              ...
              <StaggerContainer className="grid grid-cols-2 gap-3" staggerDelay={0.05}>
                <StaggerItem variant="scaleIn">
                  <AnimatedButton
                    ...
                    className="flex flex-col items-center justify-center p-4 rounded-xl border border-slate-100 hover:bg-slate-50 transition-colors gap-2 w-full"
                  >
              ...
              <div className="space-y-4">
                {[
                  ...
                  <motion.div
                    ...
                    initial={{ opacity: 0, x: -10 }}
                    animate={{ opacity: 1, x: 0 }}
                    transition={{ delay: 0.35 + i * 0.07, duration: 0.3, ease: [0.25, 0.46, 0.45, 0.94] }}
